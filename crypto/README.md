...
| 08 | errata | Not recorded | Source writeup missing from the archive — see the page for what could be reconstructed from cross-references. | [08-errata.md](08-errata.md) |
